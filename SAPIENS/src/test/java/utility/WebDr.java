...
//                    elmn.sendKeys(Keys.ARROW_DOWN);
                    Thread.sleep(2000);
//                    String xPATH = "//div[.='"+xPAthText+"']";
                    //xPAthText = xPAthText + textToSet.substring(textToSet.length()-1);
...
//                    elmn.sendKeys(Keys.RETURN);
    ...
    public void setTextSelectSpan(String textToSet, String description) throws Exception {
        try {
            if (textToSet != null) {
                wdriver.findElement(By.xpath("//div[.='" + textToSet + "']")).click();
                WriteStep(wdriver, description, "Enter Text", "Entered - " + textToSet, "PASS");
            } else {
                WriteStep(wdriver, "Object not visible - " + description, "Enter Text", "Not Entered - " + textToSet, "FAIL");
            }
            ...
            WriteStep(wdriver, "Object not visible - " + description, "Enter Text", "Not Entered - " + textToSet, "FAIL");
            System.out.println("Exception in WebDr.setTextSelect - " + e);
            throw e;
        }
    }
